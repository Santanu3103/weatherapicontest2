    ...
    function getLocation() {
     ...
     const url = `https://api.openweathermap.org/data/2.5/weather?lat=${position.coords.latitude}&lon=${position.coords.longitude}&appid=09fb2959afa26c264954d38f7af40f67`                          
                ...
                async function getData(url) {
                    ...
                    map.innerHTML = `<iframe src="http://maps.google.com?q=+${position.coords.latitude},+${position.coords.longitude}&amp;output=embed" class="w-100" height="200" allow="geolocation" loading="lazy"></iframe>`
                    const response = await fetch(url);
                     ...
                     document.getElementsByClassName('txt11')[0].innerText=`Feels Like : ${areaData.main.feels_like}`;
